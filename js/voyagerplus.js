...
const destinationsData = [
    ...
    { id: 8, name: "España", continent: "Europa", image: "https://tiendacloud01paolareyes.blob.core.windows.net/imagenespaola/Espana.jpg", description: "Descubre la arquitectura de Gaudí en Barcelona, la pasión del flamenco en Sevilla y las playas soleadas de la costa española." },
    ...
    // Oceanía
    { id: 21, name: "Australia", continent: "Oceanía", image: "https://tiendacloud01paolareyes.blob.core.windows.net/imagenespaola/australia.jpeg", description: "Un continente de contrastes, con la icónica Ópera de Sídney, la Gran Barrera de Coral y el misterioso interior." },
